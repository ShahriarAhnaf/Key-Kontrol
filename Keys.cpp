                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_KEYS, szWindowClass, MAX_LOADSTRING);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_CREATE:
        //during initialization you want to create all the menu items
    break;
    case WM_COMMAND:
        {
    ...
    case WM_PAINT:
        {
            PAINTSTRUCT ps;
            TCHAR greeting[] = _T("hello, keyboard warriors");
